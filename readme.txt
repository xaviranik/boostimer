...
Yes, Boostimer support WC Subscriptions.

= Can I use Sale and stock timer countdown simultaneously? =

Definitely yes, you can set up and manage sale and restock countdown timer together for a product.
...
1. Admin Dashboard
2. Set Sale timer
3. Sale timer frontend
4. Set Stock timer
5. Stock timer frontend
6. Supports WC Subscriptions

== Changelog ==
= v1.4.0 (18th Septemper 2022) =

- **Compatibility**: Compatibility for WordPress 6.7.1

= v1.3.0 (18th Septemper 2022) =
